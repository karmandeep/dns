        ...
        <table class="form" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="fieldarea text-left" width="65%" ><input readonly class="disabled" type="text" name="name" value="<?php echo $name_array[0]; ?>" > .<?php echo $services_array['domain']; ?> (<small><i>ReadOnly</i></small>)</td>
                ...
                <tr>
                    ...
                    <td class="fieldarea text-left" ><input type="text" name="content" value="<?php echo $content; ?>" ></td>
                    <td class="fieldlabel text-left" ></td>
                </tr>
                <tr>
                    <td class="fieldlabel text-left" ></td>
                ...
                <tr>
                    ...
                    <td class="text-center" colspan="4"><input class="btn btn-default" type="button" name="cancel" onClick="window.close();" value="Cancel">&nbsp;<input class="btn btn-primary" type="submit" name="submit" value="Edit"></td>
                </tr>
            </tbody>
        </table>    	
