                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-6 col-lg-6 pull-md-left">
                                     <input type="text" name="name" autocomplete="off" id="inputName" value="" placeholder="Enter @ or hostname" class="form-control">
                                    </div>
                    	...
                    	<form class="dns-form-add" name="add-dnsRecord-txt" method="post" action="index.php?m=dns&id={$id}&action=submit">
                           ...
                           <input type="hidden" name="domain" value="{$domain}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-6 col-lg-6 pull-md-left">
                                     <input type="text" name="name" id="inputName"  autocomplete="off" value="" placeholder="Enter @ or hostname" class="form-control">
                                    </div>
                                    <div class="col-sm-5 col-md-5 col-lg-5 pull-md-left margin-10">
                                        .{$domain}.
                                    </div>
