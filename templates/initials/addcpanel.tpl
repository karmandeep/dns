<div id="create-record-cpanel-Modal" class="modal record" role="dialog">
                    ...
                    <div id="adda" class="tab-pane active" role="add-tabpanel">
                        <form class="dns-cpanel-form-add" name="add-dnsRecord-cpanel-a" method="post" action="index.php?m=dns&{$idstring}&action=submitcpanel">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="address" autocomplete="off" id="inputContent" value="" placeholder="Select resource or enter custom IP" class="form-control">
                            </div>
                            ...
                            <div class="form-group text-right"><!--disabled-->
                                <input type="submit" name="Send" class="btn disabled btn-success create-cpanel-record" value="Create Record">
                            </div>
                        </form>
                    </div>
